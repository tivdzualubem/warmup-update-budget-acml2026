...
RUNS = [
    {
        ...
        "script": "run_warmup_safety_gate_agnews.py",
        "expected_output": "transformer_project/results/warmup_safety_gate_ag_news_agnews_warmup_safety_gate_v2_calibrated/"
    }
]

manifest = {
    "entry_command": "python transformer_project/run_stage2_agnews_warmup_safety_gate_calibrated.py",
    "dataset": "ag_news",
    "run_mode": "full",
...
manifest_path = PROJECT_DIR / "stage2_agnews_warmup_safety_gate_calibrated_manifest.json"
with open(manifest_path, "w") as f:
    json.dump(manifest, f, indent=2)

print("=" * 80)
print("AG NEWS CALIBRATED WARMUP SAFETY GATE DRIVER")
print("=" * 80)
...
print("\nFinished AG News calibrated warmup safety gate run.")
